...
const sandwichIteams = [
    {
      name:"Veg Sandwich",
      Amount:80,
      qunt:iteamOne,
      url:"https://freepngimg.com/thumb/burger%20sandwich/7-sandwich-png-image.png",
      increament : function () {
    ...
    },
    {
        ...
        Amount:150,
        qunt:iteamTwo,
        url:"https://freepngimg.com/thumb/burger%20sandwich/10-sandwich-png-image.png",
        increament : function () {
    ...
    },
    {
      ...
      Amount:200,
      qunt:iteamThree,
      url:"https://freepngimg.com/thumb/burger%20sandwich/33-sandwich-png-image.png",
      increament : function () {
    ...
    },
    {
        ...
        Amount:180,
        qunt:iteamFour,
        url:"https://freepngimg.com/thumb/burger%20sandwich/35-sandwich-png-image.png",
        increament : function () {
  ...
  return(
      ...
      <Container style={{paddingTop:"15vh",paddingBottom:"10vh",backgroundColor:"#2C3335",display:"flex",justifyContent:"center",alignIteam:"center"}} fluid>
          <Row className="row align-items-center">
            {sandwichIteams.map((burgerIteams,index) => {
              return(
