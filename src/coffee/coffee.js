...
const coffeeIteams = [
    {
      ...
      Amount:50,
      qunt:iteamOne,
      url:"https://freepngimg.com/thumb/cup/6-coffee-cup-png-image.png",
      increament : function () {
    ...
    },
    {
        ...
        Amount:30,
        qunt:iteamTwo,
        url:"https://freepngimg.com/thumb/coffee/3-2-coffee-png-file.png",
        increament : function () {
    ...
    },
    {
      ...
      Amount:200,
      qunt:iteamThree,
      url:"https://freepngimg.com/thumb/coffee/7-2-coffee-free-download-png.png",
      increament : function () {
    ...
    },
    {
        ...
        Amount:250,
        qunt:iteamFour,
        url:"https://freepngimg.com/thumb/coffee/30413-4-coffee-cup-file.png",
        increament : function () {
  ...
  return(
      ...
      <Container style={{paddingTop:"15vh",paddingBottom:"10vh",backgroundColor:"#2C3335",display:"flex",justifyContent:"center",alignIteam:"center"}} fluid>
          <Row className="row align-items-center">
            {coffeeIteams.map((burgerIteams,index) => {
              return(
